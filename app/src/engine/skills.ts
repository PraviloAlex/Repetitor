...
export const SKILLS: SkillDefinition[] = [
  ...
  { id: "inequality-read", topicId: "operaciones", titleEs: "Leer e interpretar desigualdades", level: 3, prerequisiteSkillIds: ["addition", "subtraction"], templateIds: ["inequality-range"], typicalMistakes: ["Confundir mayor que (abierto) con al menos (cerrado)", "Invertir los simbolos < y >"], repairExplanationEs: "Mayor que A nunca incluye A (usa <). Al menos A si incluye A (usa ≤). Analiza cada extremo por separado.", parentSignalEs: "Este tipo aparece en CIEEM desde 2011. El nino necesita distinguir extremos abiertos y cerrados." },
  { id: "division-with-remainder", topicId: "divisibilidad", titleEs: "Division con resto y hallar n", level: 3, prerequisiteSkillIds: ["division", "multiplication"], templateIds: ["division-find-n"], typicalMistakes: ["Olvidar sumar el resto al final", "Confundir divisor con cociente"], repairExplanationEs: "La formula es: n = divisor x cociente + resto. Comprobalo multiplicando.", parentSignalEs: "Este tipo aparece en el examen de ingreso. El nino necesita dominar la relacion dividendo-divisor-cociente-resto." },
  { id: "geometry-formulas", topicId: "geometria", titleEs: "Formulas de area y perimetro con variables", level: 2, prerequisiteSkillIds: ["rectangle-area", "rectangle-perimeter"], templateIds: ["geometry-formula-choice"], typicalMistakes: ["Confundir la formula de area con la de perimetro", "Usar b + h en vez de b x h para el area"], repairExplanationEs: "Area siempre multiplica dimensiones. Perimetro siempre suma lados.", parentSignalEs: "El nino confunde area y perimetro con variables." },
  { id: "multi-step-reasoning", topicId: "fracciones", titleEs: "Problemas de varios pasos", level: 4, prerequisiteSkillIds: ["fraction-of-number", "subtraction"], templateIds: ["multi-step-word-problem", "fraction-of-number", "fraction-of-number-remainder", "fraction-add-diff-den", "fraction-sub-diff-den"], typicalMistakes: ["Aplicar cada operacion al total original en vez del anterior", "Perder el hilo despues del segundo paso"], repairExplanationEs: "Resuelve paso a paso y escribe cada resultado intermedio antes de continuar.", parentSignalEs: "Este tipo aparece en el examen de ingreso." },
];
