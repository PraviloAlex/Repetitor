...
export const SKILLS: SkillDefinition[] = [
  ...
  { id: "fraction-of-number", topicId: "fracciones", titleEs: "Fraccion de una cantidad", level: 3, prerequisiteSkillIds: ["division", "multiplication"], templateIds: ["fraction-of-number", "fraction-of-number-remainder", "fraction-add-whole-and-fraction", "fraction-sub-same-den", "fraction-compare-to-unit"], typicalMistakes: ["Multiplicar sin dividir por el denominador"] },
  {
  ...
  { id: "budget", topicId: "porcentajes", titleEs: "Presupuesto despues de descuento", level: 4, prerequisiteSkillIds: ["discount"], templateIds: ["discount-budget", "discount-leftover-money", "increase-budget-gap", "discount-price", "double-discount"], typicalMistakes: ["No hacer el segundo paso de comparar con el dinero disponible"] },
...
export function getSkillRepairExplanation(skillTag: string): string {
  ...
  return skill.repairExplanationEs ?? `Revisar: ${skill.typicalMistakes[0] ?? "procedimiento incompleto"}.`;
}
