...
function buildGeometria(template: TemplateId, difficulty: number, params: number[]): Question {
  ...
  if (template === "rect-missing-side-area" || template === "rect-missing-side-perimeter") {
    ...
    return {
      ...
      hint: { es: isArea ? "Area = lado × lado. Usa division." : "Perimetro = 2 x (largo + ancho). Primero divide por 2.", ru: isArea ? "Площадь = сторона × сторона. Используй деление." : "Периметр = 2 x (длина + ширина). Сначала раздели на 2." },
  ...
  if (template === "square-area" || template === "square-perimeter") {
    ...
    return {
      ...
      hint: { es: isArea ? "Area del cuadrado: lado × lado." : "Perimetro del cuadrado: 4 × lado.", ru: isArea ? "Площадь квадрата: сторона × сторона." : "Периметр квадрата: 4 x сторона." },
    ...
    const VARIANTS: FV[] = [
      {
        ...
        explanationEs: "Area = base × altura = b × h. Sumar los lados da el perimetro, no el area.",
        explanationRu: "Площадь = основание × высота = b × h. Сумма сторон — это периметр, не площадь.",
      ...
      },
      {
        ...
        explanationEs: "Perimetro = 2 lados largos + 2 lados cortos = 2 × (b + h).",
        explanationRu: "Периметр = 2 длинных стороны + 2 короткие = 2 × (b + h).",
      ...
      },
      {
        ...
        explanationEs: "El cuadrado tiene b = h = l. Area = l × l.",
        explanationRu: "У квадрата b = h = l. Площадь = l × l.",
        mistakeEs: "Confundir area (l × l) con perimetro del cuadrado (4 × l).",
        mistakeRu: "Перепутать площадь (l × l) с периметром квадрата (4 × l).",
        hintEs: "Area = lado × lado. Para el perimetro seria 4 × lado.",
        hintRu: "Площадь = сторона × сторона. Периметр был бы 4 × сторона.",
